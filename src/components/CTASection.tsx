      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          <h2 className="font-heading text-3xl leading-tight text-white md:text-4xl lg:text-5xl">
            ...
            <br />
            <span className="text-gold">or Lead with AI?</span>
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
            Whether your organisation is entering new markets or preparing
            leaders for AI transformation, MitsuBridge is ready to help.
          </p>
